...
Aleatoric.const_set :MIDI_Acoustic_Grand_Piano, 0
Aleatoric.const_set :MIDI_Bright_Acoustic_Piano, 1
Aleatoric.const_set :MIDI_Electric_Grand_Piano, 2
Aleatoric.const_set :MIDI_Honky_tonk_Piano, 3
Aleatoric.const_set :MIDI_Electric_Piano_1, 4
Aleatoric.const_set :MIDI_Electric_Piano_2, 5
Aleatoric.const_set :MIDI_Harpsichord, 6
Aleatoric.const_set :MIDI_Clavi, 7
Aleatoric.const_set :MIDI_Celesta, 8
Aleatoric.const_set :MIDI_Glockenspiel, 9
Aleatoric.const_set :MIDI_Music_Box, 10
Aleatoric.const_set :MIDI_Vibraphone, 11
Aleatoric.const_set :MIDI_Marimba, 12
Aleatoric.const_set :MIDI_Xylophone, 13
Aleatoric.const_set :MIDI_Tubular_Bells, 14
Aleatoric.const_set :MIDI_Dulcimer, 15
Aleatoric.const_set :MIDI_Drawbar_Organ, 16
Aleatoric.const_set :MIDI_Percussive_Organ, 17
Aleatoric.const_set :MIDI_Rock_Organ, 18
Aleatoric.const_set :MIDI_Church_Organ, 19
Aleatoric.const_set :MIDI_Reed_Organ, 20
Aleatoric.const_set :MIDI_Accordion, 21
Aleatoric.const_set :MIDI_Harmonica, 22
Aleatoric.const_set :MIDI_Tango_Accordion, 23
Aleatoric.const_set :MIDI_Acoustic_Guitar_nylon, 24
Aleatoric.const_set :MIDI_Acoustic_Guitar_steel, 25
Aleatoric.const_set :MIDI_Electric_Guitar_jazz, 26
Aleatoric.const_set :MIDI_Electric_Guitar_clean, 27
Aleatoric.const_set :MIDI_Electric_Guitar_muted, 28
Aleatoric.const_set :MIDI_Overdriven_Guitar, 29
Aleatoric.const_set :MIDI_Distortion_Guitar, 30
Aleatoric.const_set :MIDI_Guitar_harmonics, 31
Aleatoric.const_set :MIDI_Acoustic_Bass, 32
Aleatoric.const_set :MIDI_Electric_Bass_finger, 33
Aleatoric.const_set :MIDI_Electric_Bass_pick, 34
Aleatoric.const_set :MIDI_Fretless_Bass, 35
Aleatoric.const_set :MIDI_Slap_Bass_1, 36
Aleatoric.const_set :MIDI_Slap_Bass_2, 37
Aleatoric.const_set :MIDI_Synth_Bass_1, 38
Aleatoric.const_set :MIDI_Synth_Bass_2, 39
Aleatoric.const_set :MIDI_Violin, 40
Aleatoric.const_set :MIDI_Viola, 41
Aleatoric.const_set :MIDI_Cello, 42
Aleatoric.const_set :MIDI_Contrabass, 43
Aleatoric.const_set :MIDI_Tremolo_Strings, 44
Aleatoric.const_set :MIDI_Pizzicato_Strings, 45
Aleatoric.const_set :MIDI_Orchestral_Harp, 46
Aleatoric.const_set :MIDI_Timpani, 47
Aleatoric.const_set :MIDI_String_Ensemble_1, 48
Aleatoric.const_set :MIDI_String_Ensemble_2, 49
Aleatoric.const_set :MIDI_SynthStrings_1, 50
Aleatoric.const_set :MIDI_SynthStrings_2, 51
Aleatoric.const_set :MIDI_Choir_Aahs, 52
Aleatoric.const_set :MIDI_Voice_Oohs, 53
Aleatoric.const_set :MIDI_Synth_Voice, 54
Aleatoric.const_set :MIDI_Orchestra_Hit, 55
Aleatoric.const_set :MIDI_Trumpet, 56
Aleatoric.const_set :MIDI_Trombone, 57
Aleatoric.const_set :MIDI_Tuba, 58
Aleatoric.const_set :MIDI_Muted_Trumpet, 59
Aleatoric.const_set :MIDI_French_Horn, 60
Aleatoric.const_set :MIDI_Brass_Section, 61
Aleatoric.const_set :MIDI_SynthBrass_1, 62
Aleatoric.const_set :MIDI_SynthBrass_2, 63
Aleatoric.const_set :MIDI_Soprano_Sax, 64
Aleatoric.const_set :MIDI_Alto_Sax, 65
Aleatoric.const_set :MIDI_Tenor_Sax, 66
Aleatoric.const_set :MIDI_Baritone_Sax, 67
Aleatoric.const_set :MIDI_Oboe, 68
Aleatoric.const_set :MIDI_English_Horn, 69
Aleatoric.const_set :MIDI_Bassoon, 70
Aleatoric.const_set :MIDI_Clarinet, 71
Aleatoric.const_set :MIDI_Piccolo, 72
Aleatoric.const_set :MIDI_Flute, 73
Aleatoric.const_set :MIDI_Recorder, 74
Aleatoric.const_set :MIDI_Pan_Flute, 75
Aleatoric.const_set :MIDI_Blown_Bottle, 76
Aleatoric.const_set :MIDI_Shakuhachi, 77
Aleatoric.const_set :MIDI_Whistle, 78
Aleatoric.const_set :MIDI_Ocarina, 79
Aleatoric.const_set :MIDI_Lead_1_square, 80
Aleatoric.const_set :MIDI_Lead_2_sawtooth, 81
Aleatoric.const_set :MIDI_Lead_3_calliope, 82
Aleatoric.const_set :MIDI_Lead_4_chiff, 83
Aleatoric.const_set :MIDI_Lead_5_charang, 84
Aleatoric.const_set :MIDI_Lead_6_voice, 85
Aleatoric.const_set :MIDI_Lead_7_fifths, 86
Aleatoric.const_set :MIDI_Lead_8_bass_plus_lead, 87
Aleatoric.const_set :MIDI_Pad_1_new_age, 88
Aleatoric.const_set :MIDI_Pad_2_warm, 89
Aleatoric.const_set :MIDI_Pad_3_polysynth, 90
Aleatoric.const_set :MIDI_Pad_4_choir, 91
Aleatoric.const_set :MIDI_Pad_5_bowed, 92
Aleatoric.const_set :MIDI_Pad_6_metallic, 93
Aleatoric.const_set :MIDI_Pad_7_halo, 94
Aleatoric.const_set :MIDI_Pad_8_sweep, 95
Aleatoric.const_set :MIDI_FX_1_rain, 96
Aleatoric.const_set :MIDI_FX_2_soundtrack, 97
Aleatoric.const_set :MIDI_FX_3_crystal, 98
Aleatoric.const_set :MIDI_FX_4_atmosphere, 99
Aleatoric.const_set :MIDI_FX_5_brightness, 100
Aleatoric.const_set :MIDI_FX_6_goblins, 101
Aleatoric.const_set :MIDI_FX_7_echoes, 102
Aleatoric.const_set :MIDI_FX_8_sci_fi, 103
Aleatoric.const_set :MIDI_Sitar, 104
Aleatoric.const_set :MIDI_Banjo, 105
Aleatoric.const_set :MIDI_Shamisen, 106
Aleatoric.const_set :MIDI_Koto, 107
Aleatoric.const_set :MIDI_Kalimba, 108
Aleatoric.const_set :MIDI_Bag_pipe, 109
Aleatoric.const_set :MIDI_Fiddle, 110
Aleatoric.const_set :MIDI_Shanai, 111
Aleatoric.const_set :MIDI_Tinkle_Bell, 112
Aleatoric.const_set :MIDI_Agogo, 113
Aleatoric.const_set :MIDI_Steel_Drums, 114
Aleatoric.const_set :MIDI_Woodblock, 115
Aleatoric.const_set :MIDI_Taiko_Drum, 116
Aleatoric.const_set :MIDI_Melodic_Tom, 117
Aleatoric.const_set :MIDI_Synth_Drum, 118
Aleatoric.const_set :MIDI_Reverse_Cymbal, 119
Aleatoric.const_set :MIDI_Guitar_Fret_Noise, 120
Aleatoric.const_set :MIDI_Breath_Noise, 121
Aleatoric.const_set :MIDI_Seashore, 122
Aleatoric.const_set :MIDI_Bird_Tweet, 123
Aleatoric.const_set :MIDI_Telephone_Ring, 124
Aleatoric.const_set :MIDI_Helicopter, 125
Aleatoric.const_set :MIDI_Applause, 126
Aleatoric.const_set :MIDI_Gunshot, 127
