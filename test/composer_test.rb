...
def test__instruction_players_ensembles
  throw_on_failure = false
  test_name = "test__instruction_players_instructions"
  lite_syntax = true
  script = 
%Q{
# TESTING PURPOSES ONLY
reset_script_state
# test__instruction_players_instructions
...
def test__instruction_state
  throw_on_failure = false
  test_name = "test__instruction_state"
  lite_syntax = true
  script = 
%Q{
# TESTING PURPOSES ONLY
reset_script_state
# test__instruction_state
...
# impl. in test_user_instruction.rb
# NOTE: TODO TERRIBLE LEAKING abstraction
# This only works as a Player instruction, but why should person composer care?
...
write "composer_test_results.txt"
  ...
  expected2 = 'i 1 1.00000 0.50000 1000 7.01000 1 ; 1'
  expected3 = 'i 2 2.00000 1.00000 1100 7.02000 1 ; 2'
  expected4 = 'i 1 1.00000 0.50000 1000 7.01000 1 ; 1'
  expected5 = 'i 2 2.00000 1.00000 1100 7.02000 1 ; 2'
  ...
  expected10 = 'i 3 3.00000 1.50000 1200 7.03000 1 ; 3'
  expected11 = 'i 4 4.00000 2.00000 1300 7.04000 1 ; 4'
...
def run_tests(flags='all')
  ...
  if not run_only
    ...
    begin
      ...
      test__instruction_state ; num_tests += 1
